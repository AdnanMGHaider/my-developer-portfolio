...
const AboutMeSection = () => {
  return (
    <section className="w-11/12 mx-auto pb-12 pt-16 xs:pb-14 xs:pt-20 md:pb-16 md:pt-24 xl:pb-20 xl:pt-28">
      ...
      <div className="w-11/12 max-w-[40rem] mx-auto bg-aboutMeDescriptionSticker bg-center bg-cover p-4 2xs:p-6 xs:p-8 xmd:px-10 xl:p-12 rounded-md flex flex-col space-y-6">
